				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							...
							<form class="form-auth-small" action="<?=base_url('index.php');?>/login/proses_login_pelanggan" method="post">
								...
								<p>Don't Have Account ? <a href="<?=base_url('index.php');?>/login/register_pelanggan">Register</a></p>
							</form>
						</div>
					</div>
					<div class="right">
